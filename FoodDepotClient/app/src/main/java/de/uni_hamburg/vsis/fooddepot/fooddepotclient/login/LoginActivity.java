package de.uni_hamburg.vsis.fooddepot.fooddepotclient.login;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
            ...
            Snackbar.make(mEmailView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
                    .setAction(android.R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            requestPermissions(new String[]{READ_CONTACTS}, FoodDepotPermissions.REQUEST_READ_CONTACTS);
                        }
                    });
        } else {
            requestPermissions(new String[]{READ_CONTACTS}, FoodDepotPermissions.REQUEST_READ_CONTACTS);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == FoodDepotPermissions.REQUEST_READ_CONTACTS) {
...
//            mAuthTask.execute((Void) null);
            RestClient.createAccount("testUser4", password, email, new BaseResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                    ...
                    showProgress(false);
                    Response<Boolean, ContentAndDistance> response = (new Gson()).fromJson(new String(responseBody), Response.class);
