package de.uni_hamburg.vsis.fooddepot.fooddepotclient.SpeechRecognition;
...
/**
 * Most parts of the code based on https://software.intel.com/en-us/articles/developing-android-applications-with-voice-recognition-features
 *
...
public class SpeechRecognitionHelper {
    ...
    private static void startRecognitionActivity(Activity callerActivity) {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_MAX_RESULTS, 1);    // quantity of results we want to receive; choosing only 1st -  the most relevant

        // start Activity ant waiting the result
        callerActivity.startActivityForResult(intent, FoodDepotConstants.VOICE_RECOGNITION_REQUEST_CODE);
    }
